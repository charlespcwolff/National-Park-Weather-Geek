...
namespace ParkGeekMVC.Controllers
{
    public class UserController : AuthenticationController
    {
        ...
        /// <summary>
        /// Main login screen, user should be redirected
        /// here by all pages if they haven't logged in yet.
        /// </summary>
        /// <returns></returns>
        [HttpGet]
        ...
        /// <summary>
        /// Screen to allow a new user to register.
        /// </summary>
        /// <returns></returns>
        [HttpGet]
        ...
        /// <summary>
        /// For validating the information new user provided and
        /// storing it if it was good.
        /// </summary>
        /// <param name="vm"></param>
        /// <returns></returns>
        [HttpPost]
